...
- The planted charge beeps faster as the fuse runs down, one long tone at the end, and the blast is
  real: a stacked fireball, a shockwave ring, a map-wide bang, certain death within 9 m and a hit out
  to 22 m for either side. Plant and defuse are announced with tones.
