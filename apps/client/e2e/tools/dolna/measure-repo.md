...
- low (0.5–1.0) 8 · crouch (1.2–1.6) 15 · full (2.0–2.8) 26 · structure (≥ 2.8) 36 · off the language: none — ok
- solids not standing on the ground or on another solid: shed_chair_1_back (minY 0.62), shed_chair_2_back (minY 0.62) — **FAIL**
- man-height cover narrower than a body in both axes (< 0.9 m; deliberate "partial" cover only): garage_wall_w_j1, garage_wall_s_j0, hall_lift_post_w, hall_lift_post_e, tree_w_trunk, tree_e_trunk, tree_mid_trunk, tree_n_trunk, shell_wall_n_j0, shell_wall_w_j1
