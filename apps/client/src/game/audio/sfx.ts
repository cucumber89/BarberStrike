...
const GUNS: Record<WeaponId, GunVoice> = {
  ...
  machinepistol: { f0: 330, body: 0.025, tail: 0.08, tailLp: 5600, clickHp: 5000, click: 0.005, crack: 0, crackLen: 0, width: 1, level: 0.58, verb: 0.18 },
  ...
  carbine:  { f0: 175, body: 0.055, tail: 0.32, tailLp: 3000, clickHp: 3100, click: 0.011, crack: 2800, crackLen: 0.018, width: 1, level: 0.80, verb: 0.34 },
  ...
  autoshotgun: { f0: 92, body: 0.09, tail: 0.45, tailLp: 1700, clickHp: 2300, click: 0.014, crack: 0, crackLen: 0, width: 2, level: 0.84, verb: 0.42 },
