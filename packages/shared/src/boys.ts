...
export const BOYS: Record<BoysClass, BoysClassDef> = {
  1: { name: "Scout", health: 85, speed: 1.15, starter: "smg", weapons: ["smg", "smg2", "shotgun", "carbine"], items: ["knife", "smoke", "energy", "fade", "light"], blurb: "Flank & capture · +15% speed · counts as two on points · 85 HP" },
  2: { name: "Assault", health: 110, speed: 1, starter: "rifle", weapons: ["rifle", "shotgun", "autoshotgun", "carbine", "launcher"], items: ["frag", "flash", "flask", "light", "heavy"], blurb: "Break defences · 110 HP · free frag every spawn" },
  3: { name: "Heavy", health: 150, speed: .85, starter: "lmg", weapons: ["lmg", "shotgun", "autoshotgun"], items: ["molotov", "smoke", "flask", "light", "heavy"], blurb: "Hold the line · 150 HP · -15% speed · LMG from spawn · suppress lanes" },
  4: { name: "Medic", health: 100, speed: 1.05, starter: "smg", weapons: ["smg", "shotgun", "carbine"], items: ["smoke", "flash", "roids", "energy", "light"], blurb: "Heal allies 6 HP/s in combat, 10 HP/s after 3s without damage · 6m, line of sight · earns support cash" },
  5: { name: "Marksman", health: 90, speed: 1, starter: "dmr", weapons: ["dmr", "sniper", "carbine"], items: ["knife", "smoke", "roids", "fade", "light"], blurb: "Cover long lanes · 90 HP · recover 5 HP/s after 4s without damage" },
};
...
export const boysAllows = (v: unknown, item: string): boolean => {
  const c = boysClass(v);
  return item === "pistol" || item === "revolver" || item === "machinepistol" || item === "clippers" || c.weapons.some(w => w === item) || c.items.includes(item);
};
