...
export const CHALLENGE_POOL: readonly ChallengeDef[] = [
  ...
  { id: "waves-6", text: "Przetrwaj 6 rund w trybie Bomb", goal: 6, xp: 450, count: (s) => s.wavesSurvived },
  { id: "bomb-1", text: "Rozegraj mecz Bomb Plant", goal: 1, xp: 300, count: (s) => (s.mode === "bomb" ? 1 : 0) },
