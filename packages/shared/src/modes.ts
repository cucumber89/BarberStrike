...
export const MODES: Record<GameMode, ModeDef> = {
  ...
  boys: { id: "boys", name: "THE BOYS", short: "BOYS", blurb: "5 classes · capture A / B / C · first to 100 points · B to buy / change class", teams: true, scoreLimit: DOM.scoreLimit },
...
export const MODE_ORDER: readonly GameMode[] = ["tdm", "boys", "dom", "bomb"];
