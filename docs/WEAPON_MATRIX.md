...
Global at the original eleven-weapon baseline (this is why they felt alike from the hip):
...
| **MP-11 Taper Fade** (machinepistol) | *A sideways saw.* Steps 5–7 mrad up with alternating 11–15 mrad side kick, jitter 0.32, delay 45 ms, recover 14/s. | 900 rpm (67 ms), automatic. The slide is a blur rather than a hand-worked action. | 0.88 zoom, 80 ms. No overlay. Sens ×0.88. | Sway ×0.7. Sprint-out 70 ms. Raise 45 %. Mobility 1.04. | f0 330, body 0.025, tail 0.08, no crack, mono, level 0.58. A dry, high mechanical chatter. | Flash 0.12, shake 0.0025, narrow tracer, one tiny casing right. |
...
| **C-20 Side Part** (carbine) | *A paced diagonal hop.* Steps 24–29 mrad up, alternating 8–11 side, jitter 0.12, delay 75 ms, recover 9/s. | 400 rpm (150 ms), semi-auto. The short action snaps shut between deliberate taps. | 0.70 zoom, 115 ms. No overlay. Sens ×0.70. | Sway ×0.75. Sprint-out 125 ms. Raise 68 %. Mobility 0.98. | f0 175, body 0.055, tail 0.32, crack 2800, mono, level 0.80. Shorter and drier than the AR-31. | Flash 0.20, shake 0.005, standard tracer, one compact rifle casing right. |
...
| **SG-6 Hot Towel** (autoshotgun) | *Three short gas shoves.* Steps 44–49 mrad up, alternating 17–20 side, jitter 0.28, delay 90 ms, recover 7/s. | 210 rpm (286 ms), semi-auto. A visible 70 ms bolt snap replaces the pump. | 0.88 zoom, 145 ms. No overlay. Sens ×0.88. Uses the pellet spread ring. | Sway ×1.35. Sprint-out 210 ms. Raise 92 %. Mobility 0.90. | f0 92, body 0.09, tail 0.45, no crack, wide, level 0.84. A short metallic boom. | Flash 0.32, shake 0.009, eight short tracers, one large red shell at the bolt cycle. |
